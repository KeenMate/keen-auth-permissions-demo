defmodule KeenAuthPermissionsDemoWeb.Api.GroupsApiController do
  ...
  api_handler(:get_groups_for_tenant, @tenant_scheme, permissions: ["tenants.get_groups"])
  ...
  api_handler(:enable_group, @tenant_and_group_scheme, permissions: ["groups.update_group"])
  ...
  api_handler(:disable_group, @tenant_and_group_scheme,
    permissions: ["groups.update_group"]
  )
  ...
  api_handler(:lock_group, @tenant_and_group_scheme, permissions: ["groups.lock_group"])
  ...
  api_handler(:unlock_group, @tenant_and_group_scheme, permissions: ["groups.update_group"])
  ...
  api_handler(:delete_group, @tenant_and_group_scheme, permissions: ["groups.delete_group"])
  ...
  api_handler(:group_info, @tenant_and_group_scheme,
    permissions: {["groups.get_members", "groups.get_group"], :and}
  )
  ...
  api_handler(:create_group, @create_group_scheme, permissions: ["groups.create_group"])
  ...
  api_handler(:add_user_to_group, @group_member_scheme,
    permissions: ["groups.create_member"]
  )
  ...
  api_handler(:remove_user_from_group, @group_member_scheme,
    permissions: ["groups.delete_member"]
  )
  ...
  api_handler(:get_user_groups_mappings, @tenant_and_group_scheme,
    permissions: ["groups.get_mapping"]
  )
  ...
  api_handler(:create_user_group_mapping, @create_user_group_mapping_scheme,
    permissions: ["groups.create_mapping"]
  )
  ...
  api_handler(:delete_user_group_mapping, @mapping_scheme,
    permissions: ["groups.delete_mapping"]
  )
  ...
  api_handler(:get_assigned_permissions, @tenant_and_group_scheme,
    permissions: ["groups.get_permissions"]
  )
  ...
  api_handler(:unassign_permissions, @unassign_permission,
    permissions: ["permissions.unassign_permission"]
  )
