defmodule KeenAuthPermissionsDemo.Auth.GroupsProvider do
  ...
  def enable_group(
    ...
    DbContext.auth_enable_user_group(username, id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
  ...
  def disable_group(
    ...
    DbContext.auth_disable_user_group(username, id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
  ...
  def lock_group(
    ...
    DbContext.auth_lock_user_group(username, id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
  ...
  def unlock_group(
    ...
    DbContext.auth_unlock_user_group(username, id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
  ...
  def delete_group(
    ...
    DbContext.auth_delete_user_group(username, id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
  ...
  def group_info(
    ...
    DbContext.auth_get_user_group_by_id(username, id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
  ...
  def get_group_members(
    ...
    DbContext.auth_get_user_group_members(username, id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
  ...
  def get_user_group_mapping(
    ...
    DbContext.auth_get_user_group_mappings(username, user_id, group_id, tenant_id)
    |> ErrorParsers.parse_if_error()
  end
